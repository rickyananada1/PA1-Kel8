                ...
                <div class="container">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <p class="card-text">Bunkbed: {{ $room->bunkbed }}</p>
                            <p class="card-text">Kapasitas: {{ $room->capacity }}</p>
                            <p class="card-text">Harga: {{ $room->category->price}}</p>
                            @if ($room->gambar)
                            <img src="{{ asset('storage/'.$room->gambar) }}" class="card-img-top" alt="Room Image" style="max-width: 300px; height: auto;">
                            @endif<br><br>
                            <a href="{{ route('booking.show', ['booking' => $room->id]) }}" class="btn btn-primary float-right">Pesan</a>
                        </div>
                    </div>
                    @endforeach
                </div>
