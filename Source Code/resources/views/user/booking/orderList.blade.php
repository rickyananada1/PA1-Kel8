                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ asset('storage/' . $order->gambar_pembayaran) }}" data-toggle="modal" data-target="#imageModal{{ $order->id }}">
                                <img src="{{ asset('storage/' . $order->gambar_pembayaran) }}" alt="Bukti Pembayaran" style="width: 100px;">
                            </a>
                            @endif
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <img src="{{ asset('storage/' . $order->gambar_pembayaran) }}" alt="Bukti Pembayaran" style="width: 100%;">
                                        </div>
                                    </div>
                                </div>
                            </div>
