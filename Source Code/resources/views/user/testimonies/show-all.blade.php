...
<body>
    <div class="container-xxl bg-white p-0">
                    ...
                    <nav class="navbar navbar-expand-lg bg-dark navbar-dark p-3 p-lg-0">
                        ...
                        <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div class="navbar-nav mr-auto py-0">
                                ...
                                <a href="{{ route('testimonies.showAll') }}" class="nav-item nav-link active">Lihat Testimoni</a>
        ...
        <div class="text-center">
            <h1>-- LIST TESTIMONI --</h1>
        </div>
        <br>
        <!-- Content -->
        <div class="text-center">
            <a href="{{ route('testimonies.create') }}" class="btn btn-primary">Buat Testimoni? </a>
        </div><br>

        @foreach ($testimonies as $testimony)
        <div class="border rounded p-4 mb-4">
            <h2>{{ $testimony->user->name }}</h2>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <img src="{{ asset('storage/' . $testimony->image) }}" alt="Testimony Image" style="width: 100%;">
                        </div>
                    </div>
                </div>
            </div>
